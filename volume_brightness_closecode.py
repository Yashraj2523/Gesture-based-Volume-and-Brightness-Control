...
def main():
    ...
    try:
        while cap.isOpened():
            ...
            if left_landmark_list and right_landmark_list:
                left_thumb = left_landmark_list[0] 
                right_thumb = right_landmark_list[0]  
                thumb_distance = get_distance(frame, [left_thumb, right_thumb])
                if thumb_distance < 27:  
                    break
